...
import fondoMesa from "assets/images/desktop-wallpaper-wooden-table-simple-wood-texture-cool-1280x720-wooden-dark.jpg";
...
function Carnet() {
  ...
  const generatePDF = async () => {
    ...
    pdf.save(`${empleado.nomper}_${empleado.apeper}.pdf`);
  };
...
Carnet.propTypes = {
  ...
  empleado: PropTypes.shape({
    ...
    ofiuniadm: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
